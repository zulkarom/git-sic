...
<div id="pageintro" class="hoc clear"> 
    <article>
      ...
      <footer><a class="btn btn-danger btn-lg" href="login-page.html">Join us now ! <i class="fas fa-angle-right"></i></a></footer>
    </article>
...
<div class="wrapper row5">
  <div id="copyright" class="hoc clear"> 
    ...
    <p class="fl_left">Copyright &copy; 2021 - All Rights Reserved - <a href="#">Universiti Malaysia Kelantan</a></p>
